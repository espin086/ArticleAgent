...
def generate_title(topic:str, model:str="gpt-3.5-turbo", temperature:float=0) -> str:
    """
...
if __name__ == "__main__":
    title = generate_title("The future of AI in healthcare")
    print(generate_article(title))
